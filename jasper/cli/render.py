...
def render_error(msg: str, console: Console, hint: Optional[str] = None) -> None:
...
def render_warning(msg: str, console: Console) -> None:
    """Print a styled warning."""
    console.print(f"[bold yellow]⚠  Warning:[/bold yellow] {msg}")


def render_success(msg: str, console: Console) -> None:
