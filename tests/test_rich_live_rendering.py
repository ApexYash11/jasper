...
class TestConsoleInitialization:
    ...
    def test_force_terminal_windows_powershell(self):
        ...
        assert force_terminal is False, (
            "force_terminal should be False in plain PowerShell"
        )
    ...
    def test_force_terminal_windows_terminal(self):
        ...
        assert force_terminal is True, (
            "force_terminal should be True in Windows Terminal"
        )
    ...
    def test_force_terminal_conemu(self):
        ...
        force_terminal = is_tty and (not is_windows or is_windows_terminal or is_conemu)
    ...
    def test_force_terminal_linux_tty(self):
        ...
        assert force_terminal is True, (
            "force_terminal should be True on Linux/macOS TTY"
        )
    ...
    def test_legacy_windows_for_powershell(self):
        ...
        assert legacy_windows is True, (
            "legacy_windows should be True for plain PowerShell"
        )
    ...
    def test_legacy_windows_false_for_windows_terminal(self):
        ...
        assert legacy_windows is False, (
            "legacy_windows should be False for Windows Terminal"
        )
...
class TestGuideStyleConfiguration:
    ...
    def test_build_persistent_board_has_empty_guide_style(self):
        """build_persistent_board() tree should use guide_style=\"\"."""
